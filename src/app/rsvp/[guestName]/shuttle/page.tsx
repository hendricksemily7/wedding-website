...
export default function ShuttlePage() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto flex flex-col items-center justify-center min-h-[60vh] px-6 py-12">
      <div className="bg-white shadow-md rounded-lg p-10 w-full flex flex-col items-center">
        <h1 className={`${playfair.className} text-2xl md:text-3xl font-semibold mb-4 text-[#2D4D3A]`}>
        ...
        <h2 className="text-lg font-semibold text-[#2D4D3A] mb-2 pt-10">SHUTTLE SCHEDULE</h2>
        <div className="w-full flex flex-col md:flex-row gap-6 mb-4">
          <div className="flex-1">
            <h3 className="font-semibold mb-2 text-[#2D4D3A]">Hotel Departure Options</h3>
            <div className="flex gap-4">
                3:30 PM and 3:45 PM
            </div>
          </div>
          <div className="flex-1">
            <h3 className="font-semibold mb-2 text-[#2D4D3A]">Venue Departure Options</h3>
            <div className="flex gap-4">
                9:00 PM and 10:00 PM
            </div>
          </div>
        </div>
        <p className="mb-4 pt-10 text-gray-600 text-center">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col items-center gap-6 w-full">
          ...
          <button
            ...
            className={`border border-[#2D4D3A] text-[#2D4D3A] px-8 py-3 rounded-md font-medium tracking-wide transition
